...
export default function App() {
  ...
  const [isRecipeGotten, setIsRecipeGotten] = useState(false);
  ...
  return (
    <div className="App">
      ...
      <InputTextBox
        ...
        setIsRecipeGotten={setIsRecipeGotten}
      />
      <RandomRecipe isRecipeGotten={isRecipeGotten} randomRecipe={randomRecipe} />
      <hr />
      <h2>使い方（PC）</h2>
      <ol>
        <li>
